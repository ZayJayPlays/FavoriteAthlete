...
class AthleteTableViewController: UITableViewController {
    ...
    @IBSegueAction func addAthlete(_ coder: NSCoder) -> AthleteFormViewController? {
        let athleteFormViewController = AthleteFormViewController(coder: coder, athlete: nil)
    ...
    @IBAction func unwindBack(_ segue: UIStoryboardSegue) {
        guard let athleteFormViewController =
               segue.source as? AthleteFormViewController, let athlete = athleteFormViewController.athlete
        else {
            return
        }
